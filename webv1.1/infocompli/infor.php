					...
					if($NEWPS==$NEWPSVF)	
					{
						...
						else if($INDUSTRYTYPE=='0')
						{
							...
							//update use_login set Name = 0 ,Company=,IndustyType= where UserName='".$SN."' 
							 $sql_query="update use_login set Password='".$NEWPS."' , Phone='".$PHONE_NUM."', Email = '".$EMAIL_STR."'  , Company= '".$COMPANY."',IndustyType='".$INDUSTRYTYPE."'  , Name ='".$NAME."' where UserName='".$UserName1."' "; 
